...
namespace DataQueryInsert
{
    public class Function
    {
        ...
        string insert_query = "INSERT INTO PersonData (FirstName,LastName,Gender,DateOfBirth,TimeOfBirth,City,Country) VALUES (@FirstName ,@LastName ,@Gender , @DateOfBirth ,@TimeOfBirth ,@City ,@Country);";
